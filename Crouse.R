...
#change p values
life_pi1 <- mutate(lifetable, annual_survivorship = ifelse(stage_number == "1", annual_survivorship * 1.05, annual_survivorship * 1)) # p for survival probility, i for increase, 1 for the stage that its p is being altered
life_pd1 <- mutate(lifetable, annual_survivorship = ifelse(stage_number == "1", annual_survivorship * 0.95, annual_survivorship * 1)) # d for decrease
...
life_di5 <- mutate(lifetable, stage_duration = ifelse(stage_number == "5", annual_survivorship * 1.05, annual_survivorship * 1))
life_dd5 <- mutate(lifetable, stage_duration = ifelse(stage_number == "5", annual_survivorship * 0.95, annual_survivorship * 1))
life_di6 <- mutate(lifetable, stage_duration = ifelse(stage_number == "6", annual_survivorship * 1.05, annual_survivorship * 1))
life_dd6 <- mutate(lifetable, stage_duration = ifelse(stage_number == "6", annual_survivorship * 0.95, annual_survivorship * 1))
life_di7 <- mutate(lifetable, stage_duration = ifelse(stage_number == "7", annual_survivorship * 1.05, annual_survivorship * 1))
life_dd7 <- mutate(lifetable, stage_duration = ifelse(stage_number == "7", annual_survivorship * 0.95, annual_survivorship * 1))
#make new matrices
...
eigs_pi1 <- eigen(mat_pi2)
eigs_di1 <- eigen(mat_di2)
eigs_pi1 <- eigen(mat_pi3)
eigs_di1 <- eigen(mat_di3)
eigs_pi1 <- eigen(mat_pi4)
eigs_di1 <- eigen(mat_di4)
eigs_pi1 <- eigen(mat_pi5)
eigs_di1 <- eigen(mat_di5)
eigs_pi1 <- eigen(mat_pi6)
eigs_di1 <- eigen(mat_di6)
eigs_pi1 <- eigen(mat_pi7)
eigs_di1 <- eigen(mat_di7)
eigs_pd1 <- eigen(mat_pd1)
eigs_dd1 <- eigen(mat_dd1)
eigs_pd1 <- eigen(mat_pd2)
eigs_dd1 <- eigen(mat_dd2)
eigs_pd1 <- eigen(mat_pd3)
eigs_dd1 <- eigen(mat_dd3)
eigs_pd1 <- eigen(mat_pd4)
eigs_dd1 <- eigen(mat_dd4)
eigs_pd1 <- eigen(mat_pd5)
eigs_dd1 <- eigen(mat_dd5)
eigs_pd1 <- eigen(mat_pd6)
eigs_dd1 <- eigen(mat_dd6)
eigs_pd1 <- eigen(mat_pd7)
eigs_dd1 <- eigen(mat_dd7)


dom.pos.di1 <- which.max(eigs.mat_di1[["values"]])
LFd <- Re(eigs.mat_di1[["values"]][dom.pos.di1]) 
