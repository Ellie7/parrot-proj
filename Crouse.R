...
table.3_Surv1Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "1", annual_survivorship == 1.0, annual_survivorship * 1)) # not working yet
table.3_Surv2Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "2", annual_survivorship == 1.0, annual_survivorship * 1))
table.3_Surv3Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "3", annual_survivorship == 1.0, annual_survivorship * 1))
table.3_Surv4Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "4", annual_survivorship == 1.0, annual_survivorship * 1))
table.3_Surv5Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "5", annual_survivorship == 1.0, annual_survivorship * 1))
table.3_Surv6Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "6", annual_survivorship == 1.0, annual_survivorship * 1))
table.3_Surv7Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "7", annual_survivorship == 1.0, annual_survivorship * 1))
#eigenanalysis 
#decreases 
...
eigs.A1i <- eigen(A1i)
A2i <- myFunc(table.3_Surv1Inc) 
eigs.A2i <- eigen(A1i)
A3i <- myFunc(table.3_Surv1Inc) 
eigs.A3i <- eigen(A1i)
A4i <- myFunc(table.3_Surv1Inc) 
eigs.A4i <- eigen(A1i)
A5i <- myFunc(table.3_Surv1Inc) 
eigs.A5i <- eigen(A1i)
A6i <- myFunc(table.3_Surv1Inc) 
eigs.A6i <- eigen(A1i)
A7i <- myFunc(table.3_Surv1Inc) 
eigs.A7i <- eigen(A1i)
#finding the first eigenvalue (finite rate of increase)
#decreases
...
figure1a <- graph2 + theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) 