...
table.3_Surv5Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "5", (1-annual_survivorship+annual_survivorship), annual_survivorship * 1))
table.3_Surv6Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "6", (1-annual_survivorship+annual_survivorship), annual_survivorship * 1))
table.3_Surv7Inc <- mutate(table.3, annual_survivorship = ifelse(stage_number == "7", (1-annual_survivorship+annual_survivorship), annual_survivorship * 1))
#eigenanalysis 
#decreases 
